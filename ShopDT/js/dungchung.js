	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="/Home/tintuc"><i class="fa fa-newspaper-o"></i> Tin tức</a></li>
                <li><a href="/Home/tuyendung"><i class="fa fa-handshake-o"></i> Tuyển dụng</a></li>
                <li><a href="/Home/gioithieu"><i class="fa fa-info-circle"></i> Giới thiệu</a></li>
                <li><a href="/Home/trungtambaohanh"><i class="fa fa-wrench"></i> Bảo hành</a></li>
                <li><a href="/Home/lienhe"><i class="fa fa-phone"></i> Liên hệ</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
            ...
            <div class="tools-member">
                <div class="member">
                    ...
                    <div class="menuMember hide">
                        <a href="/Home/nguoidung">Trang người dùng</a>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.cshtml">SmartPhone Store</a> - All rights reserved © 2018 - Designed by
